...
public class NumberChecker {
    public static void main(String[] args) {
        ...
        System.out.print("Введите первое число (должно быть не больше ста): ");
        int number1 = scanner.nextInt();
        System.out.print("Введите второе число (должно быть не меньше 0): ");
        int number2 = scanner.nextInt();
        System.out.print("Введите третье число (не 0): ");
